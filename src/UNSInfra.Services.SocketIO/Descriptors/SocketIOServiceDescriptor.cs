...
public class SocketIOServiceDescriptor : IDataIngestionServiceDescriptor
{
    ...
    public Type ServiceImplementationType => typeof(SocketIOPureDataService);
    ...
    public IDataIngestionService CreateService(IDataIngestionConfiguration configuration, IServiceProvider serviceProvider)
    {
        ...
        var logger = serviceProvider.GetRequiredService<Microsoft.Extensions.Logging.ILogger<SocketIOPureDataService>>();
        
        // Create SocketIO pure data service (auto-mapping handled by generic service)
        var service = new SocketIOPureDataService(logger, socketIOConfig);
